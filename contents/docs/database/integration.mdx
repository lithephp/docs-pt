...
Explore mais sobre o Eloquent em: [Documentação completa do Eloquent](https://laravel.com/docs/eloquent)
...
Explore mais sobre MySQLi na documentação do PHP: [Documentação do PHP - MySQLi](https://www.php.net/manual/en/book.mysqli.php)
