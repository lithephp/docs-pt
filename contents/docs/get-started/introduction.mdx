...
get('/users/:id', function (Request $req) {
    ...
    // Se o usuário não for encontrado, retorna uma resposta com status 404 e uma mensagem de erro
    if (!$user) {
    ...
    // Se o usuário for encontrado, carrega a página de perfil com os dados do usuário
