...
Para instalar o middleware de Mensagens Flash para o Lithe, use o comando de instalação do módulo Line:

```bash
php line module:install flash
```

Este comando baixará e instalará o middleware de Mensagens Flash em seu projeto.
