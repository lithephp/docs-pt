...
Para instalar o middleware CORS para o Lithe, use o comando de instalação do módulo Line:

```bash
php line module:install cors
```

Este comando baixará e instalará o middleware CORS em seu projeto.
